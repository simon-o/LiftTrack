...
//        NotificationCenter.default.addObserver(self, selector: Selector(("deviceOrientationDidChange:")), name: NSNotification.Name.UIDeviceOrientationDidChange, object: nil)
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor.blue, for: UIControlState.normal)
        self.cancelButton.setTitleColor(UIColor.blue, for: UIControlState.highlighted)
        ...
        self.doneButton.setTitleColor(UIColor.blue, for: UIControlState.normal)
